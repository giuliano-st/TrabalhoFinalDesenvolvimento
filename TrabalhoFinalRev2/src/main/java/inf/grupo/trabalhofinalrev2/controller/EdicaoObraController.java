...
public class EdicaoObraController {
    ...
    public void setObraSelecionada(Obra obra) {
        ...
        // Seleciona valores atuais nos combos
        ...
        if (obra.getIdAutor() != null) {
            for (Autor a : comboAutor.getItems()) {
                if (a.getId() == obra.getIdAutor()) {
                    comboAutor.setValue(a);
                    break;
                }
            }
        }
    ...
    private void preencherCampos() {
        if (obraSelecionada != null) {
            ...
            // Editora, Assunto e Autor são tratados via ComboBox
        }
    }
    ...
    private void salvarAlteracoes() {
        if (obraSelecionada != null) {
            ...
            if (autorSelecionado != null) {
                ...
                obraSelecionada.setNome(autorSelecionado.getNome()); // seta também o nome do autor
            } else {
                obraSelecionada.setIdAutor(null); // sem autor
                obraSelecionada.setNome(null);    // ou "" se preferir
            }
