...
public class DetalhesRevistaController {
    ...
    public void handleVisualizarCapa(ActionEvent event) {
        ...
        try {
            ...
            // (Opcional) Define como modal, bloqueando a janela pai
            // capaStage.initModality(Modality.APPLICATION_MODAL);
